...
def roll_dice(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request,
                template_name="burningwheelrolls/roll_dice.html",
                context=context,
            )
    ...
    return render(request, "burningwheelrolls/roll_dice.html", {"form": form})
...
def roll_luck(request):
    if request.method == "POST":
        ...
        return render(request, "burningwheelrolls/roll_dice.html", context=context)
...
def assess_difficulty(request):
    ...
    return render(request, "burningwheelrolls/assess_difficulty.html", context=context)
